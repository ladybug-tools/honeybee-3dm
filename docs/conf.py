...
latex_documents = [
    (master_doc, 'honeybee-3dm.tex', 'honeybee-3dm Documentation',
...
man_pages = [
    (master_doc, 'honeybee-3dm', 'honeybee-3dm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'honeybee-3dm', 'honeybee-3dm Documentation',
     author, 'honeybee-3dm', 'One line description of project.',
     'Miscellaneous'),
]
